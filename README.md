...
- [Seldaek/monolog](https://github.com/Seldaek/monolog) ([3.12.0](https://github.com/Seldaek/monolog/releases/tag/3.12.0), 1 day ago) - Sends your logs to files, sockets, inboxes, databases and various web services
- [dustin10/VichUploaderBundle](https://github.com/dustin10/VichUploaderBundle) ([v2.10.1](https://github.com/dustin10/VichUploaderBundle/releases/tag/v2.10.1), 1 day ago) - A simple Symfony bundle to ease file uploads with ORM entities and ODM documents.
- [PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ([v3.95.25](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.95.25), 2 days ago) - A tool to automatically fix PHP Coding Standards issues
