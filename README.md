...
- [[make:*] Offer to install missing packages with Composer](https://github.com/symfony/maker-bundle/pull/1835) sur [symfony/maker-bundle](https://github.com/symfony/maker-bundle) (OPEN, today)
- [[Form] Document the BoundsType field](https://github.com/symfony/symfony-docs/pull/23030) sur [symfony/symfony-docs](https://github.com/symfony/symfony-docs) (CLOSED, today)
- [[Notifier] Document the deprecation of the LineNotify bridge](https://github.com/symfony/symfony-docs/pull/23027) sur [symfony/symfony-docs](https://github.com/symfony/symfony-docs) (OPEN, today)
- [Serialize entity reference nodes instead of skipping them](https://github.com/Masterminds/html5-php/pull/279) sur [Masterminds/html5-php](https://github.com/Masterminds/html5-php) (OPEN, 1 day ago)
- [Document the redirect attribute of a webspace URL](https://github.com/sulu/sulu-docs/pull/938) sur [sulu/sulu-docs](https://github.com/sulu/sulu-docs) (OPEN, 1 day ago)
