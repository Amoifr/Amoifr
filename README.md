...
- [Sylius/Sylius](https://github.com/Sylius/Sylius) ([v2.2.9](https://github.com/Sylius/Sylius/releases/tag/v2.2.9), 1 day ago) - Headless open-source eCommerce platform on top of PHP/Symfony/API Platform
- [Seldaek/monolog](https://github.com/Seldaek/monolog) ([3.11.0](https://github.com/Seldaek/monolog/releases/tag/3.11.0), 1 day ago) - Sends your logs to files, sockets, inboxes, databases and various web services
- [PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ([v3.95.24](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.95.24), 3 days ago) - A tool to automatically fix PHP Coding Standards issues
